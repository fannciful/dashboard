export const messagesData = [
  ...
  },
  {
    ...
    sender: 'Sarah Chen',
    date: 'Apr 5',
    body: "Hi Arthur, Real Estate Group has expressed interest in adding workers compensation coverage to their insurance portfolio. I've completed the initial risk assessment based",
    attachments: 3,
    truncated: true,
    column: 'left'
  },
  {
    ...
    date: 'Mar 25',
    body: "Arthur, attached please find our submission for the above mentioned applicant. We have...",
    attachments: 0,
    truncated: true,
    column: 'right'
  },
  {
    ...
    date: 'Feb 28',
    body: "Hello Arthur, I am pleased to present you with a submission on this client&#39;s upco...",
    attachments: 5,
    truncated: true,
    column: 'right'
  }
...
export const getLeftColumnMessages = () => messagesData.filter(msg => msg.column === 'left');
export const getRightColumnMessages = () => messagesData.filter(msg => msg.column === 'right');